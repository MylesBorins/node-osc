...
TInt.prototype = {
    ...
    decode: function (data) {
        ...
        this.value = unpack('>i', data.slice(0, 4))[0];
        return data.slice(4);
    },
    encode: function (buf, pos) {
...
TTime.prototype = {
    ...
    decode: function (data) {
        ...
        var raw = unpack('>LL', data.slice(0, 8));
        var secs = raw[0];
        var fracs = raw[1];
...
TFloat.prototype = {
    ...
    decode: function (data) {
        ...
        this.value = unpack('>f', data.slice(0, 4))[0];
        return data.slice(4);
    },
    encode: function (buf, pos) {
...
TBlob.prototype = {
    typetag: 'b',
    decode: function (data) {
        var length = unpack('>i', data.slice(0, 4))[0];
...
TDouble.prototype = {
    ...
    decode: function (data) {
        ...
        this.value = unpack('>d', data.slice(0, 8))[0];
        return data.slice(8);
    },
    encode: function (buf, pos) {
